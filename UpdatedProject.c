...
void drawBoard2(){
	...
	system("cls");
	printf("\n\n###################### Tic Tac Toe ######################\n\n");
	printf("\n====== You are playing with Evil(Cheater) Computer ======\n\n");
	printf("First Player O \nSecond Player X \n\n\n");
...
void drawBoard3(){
	...
	system("cls");
	printf("\n\n###################### Tic Tac Toe ######################\n\n");
	printf("\n=========== You are playing with Human Player ===========\n\n");
	printf("First Player O \nSecond Player X \n\n\n");
...
int main(){
    ...
    while(1)
    {
        system("cls");
        resetBoard();
        printf("__________________________Welcome To TIC TAC TOE Game______________________________\n\n");
        printf("Enter your choice\n\n");
        printf("1. Want to play with Smart Computer\n");
        printf("2. Want to play with Evil(Cheater) Computer\n");
